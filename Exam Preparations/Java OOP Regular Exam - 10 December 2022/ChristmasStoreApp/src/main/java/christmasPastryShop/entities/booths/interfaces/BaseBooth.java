...
public abstract class BaseBooth implements Booth {
    ...
    public double getBill() {
        double billSum = 0;
        billSum += this.delicacyOrders.stream().mapToDouble(Delicacy::getPrice).sum();
        billSum += this.cocktailOrders.stream().mapToDouble(Cocktail::getPrice).sum();
        return billSum + this.price;
    }
